...
// test results by visually inspecting outout (one file per node).
// this is really an ugly way to do this, but its simple.
// Correct output will be a linear ramp function from the left
