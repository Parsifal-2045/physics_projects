...
int main() {
  ...
  // +++++++ YOU CAN PRINT DEBUG INFO SETTING True TO THE ALLOCATOR CONSTRUCTOR
  // ++++++ BUT IF YOU WANT TO COMPARE TIMING RESULTS REMEMBER TO SET IT TO
  // FALSE "printing" slows down the program
